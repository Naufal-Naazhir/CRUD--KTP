        ...
        <div class="container">
            <form method="post" action="edit_user.php?id=<?= $user_id; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="birth_place" value="<?= $birth_place; ?>" value="<?= @$_POST['birth_place']; ?>" placeholder="Tempat lahir">
                </div>
                <div class="form-group">
                    <label>Tanggal Lahir:</label>
                    <input type="date" class="form-control" name="birth_date" value="<?= $birth_date; ?>" value="<?= @$_POST['birth_date']; ?>" placeholder="Tanggal lahir">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Alamat:</label>
                    <textarea class="form-control" name="address" placeholder="Alamat"><?= @$_POST['address']; ?> <?= $address; ?></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="job_title" value="<?= $job_title; ?>" value="<?= @$_POST['job_title']; ?>" placeholder="Pekerjaan">
                </div>
                <div class="form-group">
