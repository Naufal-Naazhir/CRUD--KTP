<?php
    ...
    if (isset($_GET['id'])) {
        ...
        if (isset($_POST['religion_name'])) {
            ...
            $query = "UPDATE `religion` SET `religion_name`='$religion_name' WHERE `religion_id`='$religion_id'";
        ...
        <div class="container">
            <form method="post" action="edit_religion.php?id=<?= $religion_id; ?>">
                <div class="form-group">
                    <label>Agama:</label>
                    <input type="text" class="form-control" name="religion_name" value="<?= $row['religion_name']; ?>" placeholder="Agama" required>
                </div>
                <br>
